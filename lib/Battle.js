var Battle = function(gameTable2){
  ...
  this.toString = function(){
		var result = "Battle[winningCard: "+this.winningCard.toString()+"\nKartyNaStole:";
  ...
  this.calculateBattleResult = function(){
	console.log("KONIEC BITWY, wygrywa: "+this.winner.playerName);
  ...
  this.setCardAsPlayer= function(cardId, playerId){
    ...
    if(!gameTable.isPlayerTurn(player)){    
      ...
      console.log("rzucona karta"+card.toString()+" usera "+player.playerName);
